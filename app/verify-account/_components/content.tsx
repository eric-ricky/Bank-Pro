              ...
              <Form {...form}>
                ...
                >
                  ...
                  {step === 2 && (
                    <>
                      <p className="text-sm text-gray-600">
                        To complete your verification, please deposit $30. This
                        amount will reflect in your account and is necessary for
                  ...
                  {step === 3 && (
                    <>
                      <p className="text-sm text-gray-600">
                        Your $30 verification deposit has been successfully
                        processed, and your account is now verified. You can now
                        access all the features of your banking account.
                      </p>
                    </>
                  )}
