...
const testimonials = [
  {
    ...
    content:
      "Bank Pro has transformed how I manage my business finances. The mobile app is intuitive and their customer service is exceptional.",
  },
  {
    name: "Michael Chen",
  ...
  },
  {
    ...
    content:
      "I recommend Bank Pro to all my clients. Their investment tools and wealth management features are unmatched.",
  },
];
